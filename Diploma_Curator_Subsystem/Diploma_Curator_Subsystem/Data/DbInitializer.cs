...
namespace Diploma_Curator_Subsystem.Data
{
    public class DbInitializer
    {
        public static void Initialize(SubsystemContext context)
        {
            ...
            {
                new Role{Name="ЛПР"},
                new Role{Name="Главный менеджер"},
                new Role{Name="Координатор"},
                new Role{Name="Аналитик"},
                new Role{Name="Куратор экспертного сообщества"},
                new Role{Name="Эксперт"}
            };
            ...
            var users = new User[]
            {
                new User{Name="Alyana",LastName="Matyusheva",Email="alk-fifa@ya.ru", Password="12345"},
