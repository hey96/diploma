...
namespace Diploma_Curator_Subsystem.Controllers
{
    public class TasksController : Controller
    {
        ...
        [Authorize]
        public async Task<IActionResult> Create([Bind("ID,Title,Description,Alternatives,Math_data,CreatedAt,ExpirationDate,StatusID,DomainID")] Models.Task task)
        {
            ...
            ViewData["DomainID"] = new SelectList(_context.Domains, "ID", "Name", task.DomainID);
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,Description,Alternatives,Math_data,CreatedAt,ExpirationDate,StatusID,DomainID")] Models.Task task)
        {
            if (id != task.ID)
            {
                return NotFound();
